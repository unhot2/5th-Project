						...
						<c:choose>
							<c:when test="${boo eq 0}">
								<c:forEach var="dto" items="${cartList}">
									...
									<tr>
										<td class="text-center"><img src="${dto.imgpath }"
	...
	<form id="cartOrder">
		<div align="center">
			...
			<table width="56%">
				<tr>
					<td class="bb">이름</td>
					<td colspan="2"><input class="form-control_orderName"
						type="text" id="orderName" name="name"
						value="${memberInfo.userName }"></td>
				</tr>
				<tr>
					<td>전화번호</td>
					<td colspan="2"><input class="form-control_orderPhone"
						type="text" id="orderPhone" name="phone"
						value="${memberInfo.userPhone }"></td>
				</tr>
				<tr>
					<td>우편번호</td>
					<td colspan="2"><input class="form-control_orderPostCode"
						type="text" id="orderPostCode" name="postCode"
						value="${memberInfo.userPostCode }"></td>
				</tr>
				<tr>
					<td>주소</td>
					<td colspan="2"><input class="form-control_orderAddr"
						type="text" id="orderAddr" name="addr"
			...
			<table width="56%">
				...
				<tr>
					<td>전화번호</td>
					<td colspan="2"><input class="form-control_rcPhone"
						type="text" name="userPhone" id="rcPhone"></td>
				</tr>
				<tr>
					<td>우편번호</td>
				...
				<tr>
					...
					<td><input type="hidden" name="totalPrice"
						...
						<button class="btn_red"
							style="width: 220px; font-size: 15px; font-weight: bold; margin-top: 20px"
							id="kakaopay" type="button">카카오페이</button></td>
				</tr>
			</table>
		</div>
	</form>
