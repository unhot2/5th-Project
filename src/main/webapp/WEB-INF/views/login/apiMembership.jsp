		...
		<div class="signup-cont cont">
			<form action="apiSaveMember" method="post">
				<span class="name">이름</span>	
					<input class="inpt" type="text" name="userName" required="required" value="${loginDTO.userName }" placeholder="이름">
				핸드폰 번호
				...
				<br><br>
				생년월일
					<input type="date" value="${memberInfo.userBirth }" name="userBirth"><br><br>
				Email
					<input class="inpt" type="text" name="userEmail" value="${loginDTO.userEmail }" placeholder="이메일">
					
					<font color="red">*</font>
					<a>개인정보용 질문</a><br>
					<select size="1" name="userQuestion" class="inpt">
