...
<style>
	.checkId{max-width:18%; max-height:50%; margin-left:700px; margin-bottom:100px;}
</style>
<section class="userFind">
    ...
    <!--
     ...
     -->
    <div class="checkId">
        <h3><img src="resources/img/etc/아이디비밀번호.png" alt="아이디 /비밀번호 찾기" /></h3>
        <fieldset>
           <form id="find" action="find">
			<table>
				<tr>
				<th>ID :</th>
				<th><input type="text" name="id" id="id" placeholder="찾을 아이디 입력"></th>
			</tr>
				<tr>
					<td colspan="2"><p class="button">
                <a id="inputBtn" ><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_submit.gif" alt="입력" /></a>
            </p></td>
				</tr>
			</table>
