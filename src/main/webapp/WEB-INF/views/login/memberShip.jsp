...
<section class="memberShipSection">
	...
	<form action="saveMember">
		...
		<p class="result"><span class="msg">아이디를 확인해 주십시오</span></p><br>
		비밀번호 : <input type="text" name="userPwd"><br>
		이름 : <input type="text" name="userName"><br>
		나이 : <input type="number" name="userAge"><br>
		주소 : <input type="text" name="userAddr"><br>
		
		<input type="text" name="#" id="postcode" placeholder="우편번호">
		<input type="button" onclick="DaumPostcode()" value="우편번호 찾기"><br>
		<input type="text" name="#" id="address" placeholder="주소">
		<input type="text" name="#" id="address2" placeholder="상세주소"><br>
		...
		<input id="submit" type="submit" value="회원가입" disabled="disabled">
	</form>
</div>
</section>
