		    ...
		    <article class="half">
                ...
                <form id="saveMember" action="saveMember" method="post" >
                							<font color="red">*</font>아이디
                							 ...
                							 <button type="button" onclick="idcheck()">아이디 확인 </button><br><br>
                							 <p class="result"><span class="msg">아이디를 확인해 주십시오</span></p>
                							 
                							<font color="red">*</font>비밀번호
                							 <input type="password" name="userPwd" id="userPwd" class="inpt" required="required" placeholder="Your password"><br><br>
                						    
                						    <font color="red">*</font>이름
						                    <input type="text" name="userName" id="userName" class="inpt" required="required" placeholder="Your name"><br><br>
						                   
						                   <font color="red">*</font>핸드폰번호
						                    <input type="text" name="userPhone" id="userPhone" class="inpt" required="required" 
						                    maxlength="11" placeholder="Your phoneNumber"><br>
						                   
						                   
						                   
						                  <font color="red">*</font>주소
						                   <input type="text" name="userPostCode" id="postcode" placeholder="postNum"><br>
						                   <input type="button" id="Phone" onclick="DaumPostcode()" value="우편번호 찾기"><br>
						                   <input type="text" name="userAddr" id="address" placeholder="주소"><br><br>
						                   
						                   	성별<br>
											남자<input type="radio" name="userGender" value="남자"checked="checked">
											여자<input type="radio" name="userGender" value="여자"><br><br>
						                   
						                   	생일<br>
						                   	<input type="date" name="userBirth"><br><br>
						                   	
						                  
						                    이메일<br>
                    						<input type="email" name="userEmail" id="email" class="inpt" required="required" placeholder="Your email"><br><br>
						                    
						                    <font color="red">*</font>개인정보용 질문
												...
												</select><br> <input type="text" name="userAnswer" id="userAnswer"><br><br>
						                    
						                    
						                    
							                  <input type="submit" value="회원가입" class="submit" disabled="disabled">
